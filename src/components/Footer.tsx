      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="mb-6">
              <p className="text-sm text-gray-600 mb-2">Founded by: <span className="font-semibold text-black">Congo Musah Adama</span></p>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/predict" className="text-gray-600 hover:text-orange-600 transition-colors">
                  Price Prediction
                </Link>
              </li>
              <li>
                <Link to="/properties" className="text-gray-600 hover:text-orange-600 transition-colors">
                  Properties
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-600">
              <li>
                <a href="mailto:info@realrateai.com" className="hover:text-orange-600 transition-colors">
                  info@realrateai.com
                </a>
              </li>
              <li>
                <a href="tel:+233531187843" className="hover:text-orange-600 transition-colors">
                  +233 531 187 8243
                </a>
              </li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-600 text-sm">
              © 2024 RealRate. All rights reserved.
            </p>
