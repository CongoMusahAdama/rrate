...
const properties = [
  {
    ...
    capacity: 8,
    features: ['Free Wi-Fi', 'Air Conditioning', 'Swimming Pool', 'Garden', 'Security', 'Parking']
  },
  {
    id: 2,
    ...
    capacity: 10,
    features: ['Free Wi-Fi', 'Air Conditioning', 'Kitchen', 'Gym', 'Security', 'Double Garage']
  },
  {
    id: 3,
    ...
    capacity: 6,
    features: ['Free Wi-Fi', 'Air Conditioning', 'Kitchen', 'Parking', 'Security', 'Garden']
  }
];
