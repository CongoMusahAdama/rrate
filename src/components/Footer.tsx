        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-600 mb-6 max-w-md">
              AI-powered real estate platform providing accurate property price predictions and helping you find your dream home.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/predict" className="text-gray-600 hover:text-gray-900 transition-colors">
                  Price Prediction
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-600">
              <li>
                <a href="mailto:info@realestate-ai.com" className="hover:text-gray-900 transition-colors">
                  info@realestate-ai.com
                </a>
              </li>
              <li>
