...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/4 right-1/4 w-48 h-48 sm:w-72 sm:h-72 bg-[#0ea5e9] opacity-10 rounded-full mix-blend-multiply filter blur-xl animate-pulse"></div>
      <div className="absolute bottom-1/4 left-1/4 w-48 h-48 sm:w-72 sm:h-72 bg-white opacity-10 rounded-full mix-blend-multiply filter blur-xl animate-pulse delay-1000"></div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20 z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          ...
          <div className={`max-w-xl transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            <h1 className={`text-3xl sm:text-4xl lg:text-6xl font-bold text-[#0ea5e9] leading-tight mb-6 transform transition-all duration-1000 delay-300 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'} drop-shadow-lg`}>
              Find A House
            ...
            <p className={`text-lg sm:text-xl text-[#0ea5e9] mb-2 leading-relaxed transform transition-all duration-1000 delay-500 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'} drop-shadow-md font-bold`}>
              Real-time, Real Estate Rates.
            </p>
            
            <p className={`text-base sm:text-lg text-white mb-8 leading-relaxed transform transition-all duration-1000 delay-700 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'} drop-shadow-md`}>
            ...
            <div className={`flex flex-col sm:flex-row gap-4 mb-12 transform transition-all duration-1000 delay-900 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              <Link
                to="/login"
                className="inline-flex items-center justify-center brand-blue-gradient text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl text-base sm:text-lg font-semibold hover:brand-blue-gradient-hover transition-all transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
                Get Started
              </Link>
              <Link
                to="/properties"
                className="inline-flex items-center justify-center bg-white/90 text-[#0ea5e9] px-6 sm:px-8 py-3 sm:py-4 rounded-xl text-base sm:text-lg font-semibold border-2 border-white/20 hover:bg-white transition-all transform hover:scale-105 shadow-md hover:shadow-lg backdrop-blur-sm"
              >
                Explore More
              </Link>
            </div>
            ...
            {/* Stats */}
            <div className={`grid grid-cols-3 gap-6 sm:gap-8 transform transition-all duration-1000 delay-1100 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              <div className="text-center">
                <div className="text-2xl sm:text-3xl font-bold text-white mb-1 drop-shadow-lg">2000+</div>
                <div className="text-xs sm:text-sm text-gray-300">Listed Properties</div>
              </div>
              <div className="text-center">
                <div className="text-2xl sm:text-3xl font-bold text-white mb-1 drop-shadow-lg">8500+</div>
                <div className="text-xs sm:text-sm text-gray-300">Happy Customers</div>
              </div>
              <div className="text-center">
                <div className="text-2xl sm:text-3xl font-bold text-white mb-1 drop-shadow-lg">150+</div>
                <div className="text-xs sm:text-sm text-gray-300">Awards</div>
              </div>
            </div>
          </div>
