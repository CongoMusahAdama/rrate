    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center text-gray-900">
          ...
          <Link
            to="/"
            className="inline-flex items-center wine-gradient text-white px-6 py-3 rounded-xl font-semibold hover:wine-gradient-hover transition-all"
          >
            Return Home
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          <Card className="bg-white border-gray-200">
            ...
            <CardContent className="space-y-4">
              <Button className="w-full justify-start wine-gradient hover:wine-gradient-hover">
          ...
          <CardContent>
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody>
                  <tr className="border-b border-gray-200">
                    <td className="py-3 px-4 text-gray-900">Modern Villa</td>
                  ...
                  <tr className="border-b border-gray-200">
                    <td className="py-3 px-4 text-gray-900">Luxury Penthouse</td>
                    <td className="py-3 px-4 text-gray-600">Cantonments, Accra</td>
                    <td className="py-3 px-4 text-gray-900">₵1,800,000</td>
                    <td className="py-3 px-4">
