    ...
    <section className="py-20 bg-gradient-to-br from-gray-50 via-white to-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          {/* Left Content */}
          <div>
            <div className="w-16 h-16 bg-gradient-to-r from-[#5a1e24] to-[#7a2a30] rounded-full flex items-center justify-center mb-8">
            ...
            <div className="space-y-6">
              <div className="w-12 h-px bg-gradient-to-r from-[#5a1e24] to-[#7a2a30]"></div>
          ...
          <div className="relative">
            <div className="text-8xl text-[#5a1e24]/20 font-serif absolute -top-8 -left-4">"</div>
